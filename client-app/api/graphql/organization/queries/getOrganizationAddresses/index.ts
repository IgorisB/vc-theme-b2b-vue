...
import queryDocument from "./getOrganizationAddresses.graphql";
import type { MemberAddressConnection, OrganizationAddressesArgs, Query, QueryOrganizationArgs } from "../../../types";
