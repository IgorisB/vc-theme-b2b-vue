...
export type AddItemToCartMutation = { addItem?: { name: string, itemsQuantity?: number } };
...
export type ChangeCartCommentMutation = { changeComment?: { name: string, itemsQuantity?: number } };
...
export type SearchCategoriesQuery = { categories?: { totalCount?: number, items?: Array<{ id: string, name: string, slug?: string, parent?: { id: string }, seoInfo?: { pageTitle?: string, metaKeywords?: string, metaDescription?: string }, breadcrumbs?: Array<{ title: string, seoPath?: string }> }> } };
